...
function dlTemplate(){var csv='ZipCode,Type,Message\n10001,allow,Delivery in 2 days!\n90210,deny,Sorry, no delivery here.';var b=new Blob([csv],{type:'text/csv'});var a=document.createElement('a');a.href=URL.createObjectURL(b);a.download='import-template.csv';document.body.appendChild(a);a.click();document.body.removeChild(a);toast('📄 Template downloaded','s');}
var _rows=[];
